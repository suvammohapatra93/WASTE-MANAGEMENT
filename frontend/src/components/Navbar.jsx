...
const Navbar = () => {
  ...
  const handlenavigation = (path)=>{
    if(isAuthenticated){
      ...
      console.log("err")
      handleerror("Pls Login to access this page")
    }
  }
  ...
  <nav className="container mx-auto flex justify-between items-center ">
    ...
    <ul className="flex space-x-6 my-1.5">
      ...
      <li className="hover:bg-gray-700 hover:bg-opacity-50 py-2 px-2 rounded" onClick={()=>{handlenavigation('/recycyclingfacilities')}}>
        Recycling facilities
      </li>
      <li className="hover:bg-gray-700 hover:bg-opacity-50 py-2 px-2 rounded mr-10"onClick={()=>{handlenavigation('/aboutus')}}>
        About US
      </li>
      <li>      
          {
            isAuthenticated ? <div className="flex items-center bg-amber-800 text-white mr-10 px-2 py-1 rounded-full">
